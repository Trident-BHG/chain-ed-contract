    ...
    Ownable
{
    ...
    event CertificateMintSuccessfull();
    ...
    function requestRandomWords() internal returns (uint256) {
        ...
        console.log("Successfully prepared extra Args");
        ...
        console.log("Successfully got request Id");
    ...
    function fulfillRandomWords(
        ...
        console.log("Inside fulfill random words");
        ...
        console.log("NFT successfully minted for student");
        emit CertificateMintSuccessfull();
    }
